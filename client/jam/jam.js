define(["util", "game", "vector", "sprite", "sound", "rect", "debug", "tilemap", "input", "cir"], function(Util, Game, Vector, Sprite, Sound, Rect, Debug, TileMap, Input, Cir) {
	var lib = {};
	...
	lib.addPreload = Util.addPreload;
